...
public class GatherWaterActuator : IActuator
{
    private readonly ISpatialContext _spatialContext;
    public GatherWaterActuator(ISpatialContext spatialContext)
    {
    ...
    public Task ExecuteAsync(NPC.Library.Character.Character character)
    {
        ...
        else
        {
            ...
            if (validTargets.Count == 0)
            {
                ...
                memory.Forget(TileType.Water, targetWater.X, targetWater.Y, targetWater.Z);
                return Task.CompletedTask;
            }
